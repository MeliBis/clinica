...
<div className="row p-5 bg-dark text-white ">
  ...
  <p className="text-secondary mt-3">Zacatlán, Puebla</p>
  <p className="text-secondary mt-3">Horario de atención</p>
  <p className="text-secondary mt-3">00:00am a 00:00pm</p>
  </div>
  <div className="col-xs-12 col-md-6 col-lg-3">
...
<div className="col-xs-12 col-md-6 col-lg-3 container-fluid">
    ...
    <li className="mt-3 container-fluid d-flex  justify-content-between">
                <a
                  href="https://www.facebook.com/kamtali.store"
                  target={"blank"}
                ...
                <a
                  href=" https://twitter.com/Kamtali_mx"
                  target={"blank"}
                  className="text-reset"
                >
                  <svg
                ...
                <Link
                  to="https://www.instagram.com/kamtali.store/"
                  target={"blank"}
